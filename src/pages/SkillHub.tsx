                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <button
                        ...
                        className={`shrink-0 ml-2 inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium rounded-md transition-colors duration-200 cursor-pointer ${
                          skill.enabled
                        ...
                        title={skill.enabled ? (t("skills.enable") ?? "启用") : (t("skills.disable") ?? "停用")}
                      >
                        <span className={`w-1.5 h-1.5 rounded-full shrink-0 ${
                          skill.enabled ? "bg-blue-500" : "bg-gray-400 dark:bg-gray-500"
                        }`} />
                        {skill.enabled ? (t("skills.enable") ?? "启用") : (t("skills.disable") ?? "停用")}
                      </button>
                    </div>
                    {skill.description && (
